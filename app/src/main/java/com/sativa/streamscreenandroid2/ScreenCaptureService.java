...
public class ScreenCaptureService extends Service {
    ...
    private Notification buildNotification() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this, CHANNEL_ID)
                        ...
                        .setContentText("Visit http://<phone-ip>:" + LanWebServer.DEFAULT_PORT + "/ on your LAN.")
    ...
    private void startCapture(int resultCode, Intent dataIntent) {
        ...
        // Start HTTP server
        try {
            lanWebServer = new LanWebServer(getApplicationContext(), LanWebServer.DEFAULT_PORT, frameBroadcaster);
            lanWebServer.start();
            Log.d(TAG, "Web server started on port " + LanWebServer.DEFAULT_PORT);
        } catch (Exception e) {
