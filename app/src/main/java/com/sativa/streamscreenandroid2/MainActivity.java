...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUi() {
        if (isSharing) {
            ...
            String urlText;
            if (ip != null) {
                urlText = "Status: SHARING\nOpen http://" + ip + ":" + LanWebServer.DEFAULT_PORT + "/ in a browser on your LAN.";
            } else {
                urlText = "Status: SHARING\nOpen http://<phone-ip>:" + LanWebServer.DEFAULT_PORT + "/ in a browser on your LAN.";
            }
            textStatus.setText(urlText);
            buttonStartStop.setText("Stop Sharing");
        } else {
            textStatus.setText("Status: Not sharing");
            buttonStartStop.setText("Start Sharing");
        }
    }
